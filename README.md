...
This ignores any power needed for production machines. This field is only present if the factory generates power.
...
This field is only present if the factory generates power and power augmentation is configured.

### "power_consumption": Real

The "power_consumption" entry reports the total power consumption of machines which require power, in MW.
This ignores any power generated inside the factory. This field is only present if the factory generates power.
